const easterEgg = ()=>{
    ...
    var x = function() {
        ...
        f(),
        e(x),
        y >= 5 ? ($(".c-pong__button").addClass("c-pong__button--visible"),
        l.render(),
        w.prototype.render = function() {
            i.moveTo(10, 300),
            i.lineTo(390, 300),
        ...
        r.render(),
        f = null,
        1) : a >= 5 ? ($(".c-pong__button").addClass("c-pong__button--visible"),
        p.render(),
        f = null,
        1) : void 0
    };
    ...
    g.prototype.move = function(e, t) {
        ...
        this.y_speed = t,
        this.x < 0 ? (this.x = 0,
        this.x_speed = 0) : this.x + this.width > 400 && (this.x = 400 - this.width,
        this.x_speed = 0)
    }
    ,
    ...
    v.prototype.update = function(e) {
        ...
        this.paddle.x < 0 ? this.paddle.x = 0 : this.paddle.x + this.paddle.width > 400 && (this.paddle.x = 400 - this.paddle.width)
    }
    ,
    ...
    k.prototype.update = function() {
        for (var e in u) {
            var t = Number(e);
            37 == t ? this.paddle.move(-4, 0) : 39 == t ? this.paddle.move(4, 0) : this.paddle.move(0, 0)
        }
    }
    ,
    ...
    T.prototype.update = function(e, t) {
        ...
        var i = this.x - 5
          ...
          , d = this.y + 5;
        this.x - 5 < 0 ? (this.x = 5,
        this.x_speed = -this.x_speed) : this.x + 5 > 400 && (this.x = 395,
        this.x_speed = -this.x_speed),
        (this.y < 0 || this.y > 600) && (this.x_speed = 0,
        this.y_speed = 3,
        this.x = 200,
        this.y = 300),
        this.y <= 0 && o.update(),
        this.y >= 600 && h.update(),
        n > 300 ? n < e.y + e.height && d > e.y && i < e.x + e.width && s > e.x && (this.y_speed = -3,
        this.x_speed += e.x_speed / 2,
        this.y += this.y_speed) : n < t.y + t.height && d > t.y && i < t.x + t.width && s > t.x && (this.y_speed = 3,
